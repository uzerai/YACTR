...
using YACTR.Infrastructure.Database.Table;

namespace YACTR.Infrastructure.Database;

public class DatabaseContext(DbContextOptions<DatabaseContext> options, IClock clock) : DbContext(options)
{
    // ############################################################
    // ##########  ENTITY SETS   ##################################
    // ############################################################
