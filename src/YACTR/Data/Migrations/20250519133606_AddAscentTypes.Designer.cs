...
namespace Dotnet.PlaygroundMigrations
{
    ...
    [Migration("20250519133606_AddAscentTypes")]
    partial class AddAscentTypes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YACTR.Model.Achievement.BaseAscent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("YACTR.Model.BaseEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("YACTR.Model.Location.RoutePitch", b =>
                {
            ...
            modelBuilder.Entity("YACTR.Model.Achievement.PitchAscent", b =>
                {
                    b.HasBaseType("YACTR.Model.Achievement.BaseAscent");
            ...
            modelBuilder.Entity("YACTR.Model.Achievement.RouteAscent", b =>
                {
                    b.HasBaseType("YACTR.Model.Achievement.BaseAscent");
            ...
            modelBuilder.Entity("YACTR.Model.Authentication.User", b =>
                {
                    b.HasBaseType("YACTR.Model.BaseEntity");
            ...
            modelBuilder.Entity("YACTR.Model.Image", b =>
                {
                    b.HasBaseType("YACTR.Model.BaseEntity");
            ...
            modelBuilder.Entity("YACTR.Model.Location.Area", b =>
                {
                    b.HasBaseType("YACTR.Model.BaseEntity");
            ...
            modelBuilder.Entity("YACTR.Model.Location.Pitch", b =>
                {
                    b.HasBaseType("YACTR.Model.BaseEntity");
            ...
            modelBuilder.Entity("YACTR.Model.Location.Route", b =>
                {
                    b.HasBaseType("YACTR.Model.BaseEntity");
            ...
            modelBuilder.Entity("YACTR.Model.Location.Sector", b =>
                {
                    b.HasBaseType("YACTR.Model.BaseEntity");
            ...
            modelBuilder.Entity("YACTR.Model.Location.RoutePitch", b =>
                {
                    b.HasOne("YACTR.Model.Location.Pitch", "Pitch")
                        .WithMany()
                    ...
                    b.HasOne("YACTR.Model.Location.Route", "Route")
                        .WithMany()
            ...
            modelBuilder.Entity("YACTR.Model.Image", b =>
                {
                    b.HasOne("YACTR.Model.Authentication.User", "Uploader")
                        .WithMany()
            ...
            modelBuilder.Entity("YACTR.Model.Location.Area", b =>
                {
                    b.HasOne("YACTR.Model.Organizations.Organization", "MaintainerOrganization")
                        .WithMany()
            ...
            modelBuilder.Entity("YACTR.Model.Location.Pitch", b =>
                {
                    b.HasOne("YACTR.Model.Location.Sector", "Sector")
                        .WithMany()
            ...
            modelBuilder.Entity("YACTR.Model.Location.Route", b =>
                {
                    ...
                    b.HasOne("YACTR.Model.Image", "TopoImage")
                        .WithOne("RelatedEntity")
                        .HasForeignKey("YACTR.Model.Location.Route", "TopoImageId")
            ...
            modelBuilder.Entity("YACTR.Model.Location.Sector", b =>
                {
                    b.HasOne("YACTR.Model.Location.Area", "Area")
                        .WithMany("Sectors")
