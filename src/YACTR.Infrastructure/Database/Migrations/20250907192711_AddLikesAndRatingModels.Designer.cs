...
namespace YACTR.Infrastructure.Database.Migrations
{
    ...
    [Migration("20250907192711_AddLikesAndRatingModels")]
    partial class AddLikesAndRatingModels
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("YACTR.Data.Model.Climbing.Rating.RouteLike", b =>
                {
                    ...
                    b.HasIndex("RouteId")
                        .HasDatabaseName("ix_route_like_route_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_route_like_user_id");

                    b.ToTable("route_like", (string)null);
                });
            ...
            modelBuilder.Entity("YACTR.Data.Model.Climbing.Rating.RouteRating", b =>
                {
                    ...
                    b.HasIndex("RouteId")
                        .HasDatabaseName("ix_route_rating_route_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_route_rating_user_id");

                    b.ToTable("route_rating", (string)null);
                });
            ...
            modelBuilder.Entity("YACTR.Data.Model.Climbing.Rating.RouteLike", b =>
                {
                    b.HasOne("YACTR.Data.Model.Climbing.Route", "Route")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_route_like_routes_route_id");
                    ...
                    b.HasOne("YACTR.Data.Model.Authentication.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_route_like_users_user_id");
            ...
            modelBuilder.Entity("YACTR.Data.Model.Climbing.Rating.RouteRating", b =>
                {
                    b.HasOne("YACTR.Data.Model.Climbing.Route", "Route")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_route_rating_routes_route_id");
                    ...
                    b.HasOne("YACTR.Data.Model.Authentication.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_route_rating_users_user_id");
