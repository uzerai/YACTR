...
namespace YACTR.Infrastructure.Database.Migrations
{
    ...
    [Migration("20251222093403_AlterRoutesUpdateForeignKeyDeleteBehaviours")]
    partial class AlterRoutesUpdateForeignKeyDeleteBehaviours
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YACTR.Data.Model.SectorImage", b =>
                {
            ...
            modelBuilder.Entity("YACTR.Data.Model.SectorImage", b =>
                {
                    b.HasOne("YACTR.Data.Model.Image", "Image")
                        .WithMany()
            ...
            modelBuilder.Entity("YACTR.Data.Model.Climbing.Route", b =>
                {
                    ...
                    b.HasOne("YACTR.Data.Model.Image", "SectorTopoImage")
                        .WithMany()
                        .HasForeignKey("SectorTopoImageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("fk_routes_images_sector_topo_image_id");

                    b.HasOne("YACTR.Data.Model.Image", "SectorTopoImageOverlaySvg")
                        .WithOne()
                        .HasForeignKey("YACTR.Data.Model.Climbing.Route", "SectorTopoImageOverlaySvgId")
                        .OnDelete(DeleteBehavior.Cascade)
            ...
            modelBuilder.Entity("YACTR.Data.Model.Climbing.Sector", b =>
                {
                    ...
                    b.HasOne("YACTR.Data.Model.Image", "PrimarySectorImage")
                        .WithOne()
                        .HasForeignKey("YACTR.Data.Model.Climbing.Sector", "PrimarySectorImageId")
